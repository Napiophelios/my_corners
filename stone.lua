...
description = "Stone Corner with "..description,
tiles = {
  texture.."^([combine:32x32:23,23=default_stone_brick.png)^[transformFX",
  texture.."^([combine:32x32:23,23=default_stone_brick.png)^[transformR180",
  texture,
		"default_stone_brick.png^[transformFXR90^([combine:32x32:9,0="..texture..")^[transformFX",
		texture,
		"default_stone_brick.png^[transformFXR90^([combine:32x32:9,0="..texture..")",
		},
inventory_image = "default_stone_brick.png^[transformFXR90^([combine:32x32:9,0="..texture..")",
wield_image = "default_stone_brick.png^[transformFXR90^([combine:32x32:9,0="..texture..")",
paramtype = "light",
paramtype2 = "facedir",
drop= craft_from.." 2",
groups = group_def,
