...
minetest.register_node("new_corners:corner_stonebrick_"..basename,{
description = "StoneBrick Corner with "..description,
tiles = {
  texture.."^([combine:32x32:16,16=default_stone_brick.png)^[transformFX",
  texture.."^([combine:32x32:16,16=default_stone_brick.png)^[transformR180",
  texture,
		"default_stone_brick.png^[transformFXR90^([combine:32x32:16,0="..texture..")^[transformFX",
		texture,
		"default_stone_brick.png^[transformFXR90^([combine:32x32:16,0="..texture..")",
		},
inventory_image = "default_stone_brick.png^[transformFXR90^([combine:32x32:16,0="..texture..")",
wield_image = "default_stone_brick.png^[transformFXR90^([combine:32x32:16,0="..texture..")",
paramtype = "light",
paramtype2 = "facedir",
drop= craft_from.." 2",
groups = group_def,
...
minetest.register_craft({
		output = "new_corners:corner_stonebrick_"..basename.." 4",
		recipe = { { "default:stonebrick", craft_from, ""},
			{ "default:stonebrick", craft_from, "" },
			{ "default:stonebrick", craft_from, ""},
		} });
end
